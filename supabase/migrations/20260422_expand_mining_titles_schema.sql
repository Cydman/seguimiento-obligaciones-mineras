...
create index if not exists idx_mining_titles_organization_id
on public.mining_titles (organization_id);

create index if not exists idx_mining_titles_code
on public.mining_titles (code);